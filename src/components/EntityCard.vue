    ...
    <q-dialog v-model="showDetails">
      <q-card>
        ...
        <q-card-section>
          ...
          <p v-if="entity.website_url"><strong>Site web :</strong> <a :href="entity.website_url" target="_blank">{{ entity.website_url }}</a></p>
          <p v-if="entity.facebook_url"><strong>Facebook :</strong> <a :href="entity.facebook_url" target="_blank">{{ entity.facebook_url }}</a></p>
          <p v-if="entity.instagram_url"><strong>Instagram :</strong> <a :href="entity.instagram_url" target="_blank">{{ entity.instagram_url }}</a></p>
        </q-card-section>
        <q-card-actions>
